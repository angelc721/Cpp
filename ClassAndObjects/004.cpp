...
int main()
{
    ...
    {
        Planet("Mercury", 62.592, 0.33, 4879.4, 0, Moon("No Moon", 0, 0, 0),Moon("No Moon", 0, 0, 0), Moon("No Moon", 0, 0, 0)),
    ...
    cout<<"The planet of Moon Europa is "<<FindMoon(Moon("Europa",670900,3126,480), solarsystem); 
